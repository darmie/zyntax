...
use zyntax_compiler::{
    hir::*,
    ConstEvaluator, ConstEvalContext,
    MonomorphizationContext, monomorphize_module,
};
...
fn test_const_binary_operations() {
    ...
    let test_cases = vec![
        // Arithmetic
        (BinaryOp::Add, HirConstant::I64(5), HirConstant::I64(3), HirConstant::I64(8)),
        (BinaryOp::Sub, HirConstant::I64(10), HirConstant::I64(3), HirConstant::I64(7)),
        (BinaryOp::Mul, HirConstant::I64(4), HirConstant::I64(7), HirConstant::I64(28)),
        (BinaryOp::Div, HirConstant::I64(20), HirConstant::I64(4), HirConstant::I64(5)),
        (BinaryOp::Rem, HirConstant::I64(17), HirConstant::I64(5), HirConstant::I64(2)),
        
        // Unsigned arithmetic
        (BinaryOp::Add, HirConstant::U64(100), HirConstant::U64(50), HirConstant::U64(150)),
        (BinaryOp::Mul, HirConstant::U64(12), HirConstant::U64(12), HirConstant::U64(144)),
        
        // Bitwise
        (BinaryOp::And, HirConstant::I64(0b1111), HirConstant::I64(0b1010), HirConstant::I64(0b1010)),
        (BinaryOp::Or, HirConstant::I64(0b1100), HirConstant::I64(0b0011), HirConstant::I64(0b1111)),
        (BinaryOp::Xor, HirConstant::I64(0b1111), HirConstant::I64(0b1010), HirConstant::I64(0b0101)),
        (BinaryOp::Shl, HirConstant::I64(1), HirConstant::I64(3), HirConstant::I64(8)),
        (BinaryOp::Shr, HirConstant::I64(16), HirConstant::I64(2), HirConstant::I64(4)),
        
        // Comparisons
        (BinaryOp::Eq, HirConstant::I64(5), HirConstant::I64(5), HirConstant::Bool(true)),
        (BinaryOp::Ne, HirConstant::I64(5), HirConstant::I64(3), HirConstant::Bool(true)),
        (BinaryOp::Lt, HirConstant::I64(3), HirConstant::I64(5), HirConstant::Bool(true)),
        (BinaryOp::Gt, HirConstant::I64(10), HirConstant::I64(5), HirConstant::Bool(true)),
    ];
    
    for (op, left, right, expected) in test_cases {
        let result = ctx.eval_binary_op(op, &left, &right).unwrap();
        assert_eq!(result, expected, "Failed for {:?} with {:?} and {:?}", op, left, right);
    }
}
...
fn test_const_unary_operations() {
    ...
    // Test negation
    let result = ctx.eval_unary_op(UnaryOp::Neg, &HirConstant::I64(42)).unwrap();
    assert_eq!(result, HirConstant::I64(-42));
    
    // Test logical not
    let result = ctx.eval_unary_op(UnaryOp::Not, &HirConstant::Bool(true)).unwrap();
    assert_eq!(result, HirConstant::Bool(false));
    
    // Test bitwise not
    let result = ctx.eval_unary_op(UnaryOp::Not, &HirConstant::I64(0)).unwrap();
