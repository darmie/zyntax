...
fn test_const_evaluation_arithmetic() {
    ...
    let result = eval_ctx.eval_binary_op(BinaryOp::Add, &HirConstant::I64(5), &HirConstant::I64(3)).unwrap();
    assert_eq!(result, HirConstant::I64(8));
    
    let result = eval_ctx.eval_binary_op(BinaryOp::Mul, &HirConstant::I64(4), &HirConstant::I64(7)).unwrap();
    assert_eq!(result, HirConstant::I64(28));
    
    // Test unsigned arithmetic
    let result = eval_ctx.eval_binary_op(BinaryOp::Add, &HirConstant::U64(100), &HirConstant::U64(50)).unwrap();
...
fn test_const_evaluation_bitwise() {
    ...
    let result = ctx.eval_binary_op(BinaryOp::And, &HirConstant::I64(0b1111), &HirConstant::I64(0b1010)).unwrap();
    assert_eq!(result, HirConstant::I64(0b1010));
    
    let result = ctx.eval_binary_op(BinaryOp::Or, &HirConstant::I64(0b1100), &HirConstant::I64(0b0011)).unwrap();
    assert_eq!(result, HirConstant::I64(0b1111));
    
    let result = ctx.eval_binary_op(BinaryOp::Xor, &HirConstant::I64(0b1111), &HirConstant::I64(0b1010)).unwrap();
...
fn test_const_evaluation_comparison() {
    ...
    let result = ctx.eval_binary_op(BinaryOp::Eq, &HirConstant::I64(5), &HirConstant::I64(5)).unwrap();
    assert_eq!(result, HirConstant::Bool(true));
    
    let result = ctx.eval_binary_op(BinaryOp::Lt, &HirConstant::I64(3), &HirConstant::I64(5)).unwrap();
    assert_eq!(result, HirConstant::Bool(true));
    
    let result = ctx.eval_binary_op(BinaryOp::Gt, &HirConstant::I64(10), &HirConstant::I64(5)).unwrap();
    assert_eq!(result, HirConstant::Bool(true));
}
...
fn test_const_evaluation_with_overflow() {
    ...
    let result = ctx.eval_binary_op(BinaryOp::Add, &HirConstant::U64(u64::MAX), &HirConstant::U64(1)).unwrap();
