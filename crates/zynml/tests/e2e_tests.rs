...
mod grammar_compilation {
    ...
    fn test_language_grammar_compiles() {
        ...
        assert!(
            result.is_ok(),
            "LanguageGrammar should compile: {:?}",
            result.err()
        );
    }
...
mod module_system {
    ...
    fn test_module_declaration() {
        ...
        assert!(
            result.is_ok(),
            "Should parse module declaration: {:?}",
            result.err()
        );
    }
    ...
    fn test_dotted_module_path() {
        ...
        assert!(
            result.is_ok(),
            "Should parse dotted module path: {:?}",
            result.err()
        );
    }
...
mod type_system {
    ...
    fn test_parse_type_alias_simple() {
        ...
        assert!(
            result.is_ok(),
            "Should parse simple type alias: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_struct_colon_syntax() {
        ...
        assert!(
            result.is_ok(),
            "Should parse struct with colon syntax: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_type_struct_braces() {
        ...
        assert!(
            result.is_ok(),
            "Should parse struct type with braces: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_abstract_simple() {
        ...
        assert!(
            result.is_ok(),
            "Should parse simple abstract type: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_abstract_with_suffix() {
        ...
        assert!(
            result.is_ok(),
            "Should parse abstract with suffix: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_abstract_with_suffixes() {
        ...
        assert!(
            result.is_ok(),
            "Should parse abstract with multiple suffixes: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_trait_with_associated_type() {
        ...
        assert!(
            result.is_ok(),
            "Should parse trait with associated type: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_impl_generic_trait() {
        ...
        assert!(
            result.is_ok(),
            "Should parse generic trait impl: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_impl_abstract_inherent() {
        ...
        assert!(
            result.is_ok(),
            "Should parse abstract type impl: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_extern_struct_simple() {
        ...
        assert!(
            result.is_ok(),
            "Should parse simple extern struct: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_extern_struct_generic() {
        ...
        assert!(
            result.is_ok(),
            "Should parse generic extern struct: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_extern_struct_single_param() {
        ...
        assert!(
            result.is_ok(),
            "Should parse extern struct with single type param: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_generic_with_bounds() {
        ...
        assert!(
            result.is_ok(),
            "Should parse generic with bounds: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_generic_multiple_bounds() {
        ...
        assert!(
            result.is_ok(),
            "Should parse generic with multiple bounds: {:?}",
            result.err()
        );
    }
}
...
mod function_definitions {
    ...
    fn test_parse_function_no_return_type() {
        ...
        assert!(
            result.is_ok(),
            "Should parse function without return type: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_def_with_return_type() {
        ...
        assert!(
            result.is_ok(),
            "Should parse def with return type: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_function_expression_body() {
        ...
        assert!(
            result.is_ok(),
            "Should parse expression-bodied function: {:?}",
            result.err()
        );
    }
}
...
mod syntax_styles {
    ...
    fn test_parse_struct_brace_style() {
        ...
        assert!(
            result.is_ok(),
            "Should parse brace-style struct: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_struct_brace_generic() {
        ...
        assert!(
            result.is_ok(),
            "Should parse brace-style generic struct: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_abstract_brace_style() {
        ...
        assert!(
            result.is_ok(),
            "Should parse brace-style abstract: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_abstract_brace_with_suffix() {
        let grammar = get_grammar();
        let result =
            grammar.parse_to_json(r#"abstract Duration(i64) with Suffix("ms") { value: i64 }"#);
        assert!(
            result.is_ok(),
            "Should parse brace abstract with suffix: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_abstract_brace_with_suffixes() {
        let grammar = get_grammar();
        let result = grammar
            .parse_to_json(r#"abstract Duration(i64) with Suffixes("ms, s, m, h") { value: i64 }"#);
        assert!(
            result.is_ok(),
            "Should parse brace abstract with suffixes: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_impl_method_expression_body() {
        ...
        assert!(
            result.is_ok(),
            "Should parse expression-bodied methods: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_impl_method_brace_body() {
        ...
        assert!(
            result.is_ok(),
            "Should parse brace-bodied method: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_mixed_impl_styles() {
        ...
        assert!(
            result.is_ok(),
            "Should parse mixed impl method styles: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_complete_brace_example() {
        ...
        assert!(
            result.is_ok(),
            "Should parse complete brace-style example: {:?}",
            result.err()
        );
    }
}
...
mod literals {
    ...
    fn test_parse_triple_quoted_string() {
        ...
        assert!(
            result.is_ok(),
            "Should parse triple-quoted string: {:?}",
            result.err()
        );
    }
...
mod data_loading {
    ...
    fn test_load_as_function_call() {
        ...
        assert!(
            result.is_ok(),
            "Should parse load as function call: {:?}",
            result.err()
        );
    }
    ...
    fn test_load_with_as_type() {
        ...
        assert!(
            result.is_ok(),
            "Should parse load() with as type: {:?}",
            result.err()
        );
    }
    ...
    fn test_stream_as_function_call() {
        ...
        assert!(
            result.is_ok(),
            "Should parse stream() as function call: {:?}",
            result.err()
        );
    }
...
mod pipeline_definitions {
    ...
    fn test_pipeline_definition() {
        ...
        assert!(
            result.is_ok(),
            "Should parse pipeline definition: {:?}",
            result.err()
        );
    }
    ...
    fn test_pipeline_no_return_type() {
        ...
        assert!(
            result.is_ok(),
            "Should parse pipeline without return type: {:?}",
            result.err()
        );
    }
    ...
    fn test_pipeline_as_function_alternative() {
        ...
        assert!(
            result.is_ok(),
            "Should parse pipeline as function: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_lambda_multiple_params() {
        ...
        assert!(
            result.is_ok(),
            "Should parse lambda with multiple params: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_lambda_no_params() {
        ...
        assert!(
            result.is_ok(),
            "Should parse lambda with no params: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_lambda_in_call() {
        ...
        assert!(
            result.is_ok(),
            "Should parse lambda as function argument: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_import_asset() {
        ...
        assert!(
            result.is_ok(),
            "Should parse import asset expression: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_import_audio() {
        let grammar = get_grammar();
        let result =
            grammar.parse_to_json(r#"let audio = import audio("sound.wav") as AudioBuffer"#);
        assert!(
            result.is_ok(),
            "Should parse import audio expression: {:?}",
            result.err()
        );
    }
    ...
    fn test_parse_import_model() {
        ...
        assert!(
            result.is_ok(),
            "Should parse import model expression: {:?}",
            result.err()
        );
    }
}
...
mod compute_kernels {
    ...
    fn test_compute_with_kernel() {
        ...
        assert!(
            result.is_ok(),
            "Should parse compute() with kernel syntax: {:?}",
            result.err()
        );
    }
    ...
    fn test_workgroup_decorator() {
        ...
        assert!(
            result.is_ok(),
            "Should parse @workgroup decorator: {:?}",
            result.err()
        );
    }
...
mod visualization {
    ...
    fn test_render_simple() {
        ...
        assert!(
            result.is_ok(),
            "Should parse simple render statement: {:?}",
            result.err()
        );
    }
    ...
    fn test_render_function_call() {
        ...
        assert!(
            result.is_ok(),
            "Should parse render with function call: {:?}",
            result.err()
        );
    }
    ...
    fn test_render_with_options() {
        ...
        assert!(
            result.is_ok(),
            "Should parse render with options: {:?}",
            result.err()
        );
    }
}
...
mod streaming {
    ...
    fn test_streaming_with_pipes() {
        ...
        assert!(
            result.is_ok(),
            "Should parse streaming pattern with pipes: {:?}",
            result.err()
        );
    }
...
mod caching {
    ...
    fn test_memoize_decorator() {
        ...
        assert!(
            result.is_ok(),
            "Should parse @memoize decorator: {:?}",
            result.err()
        );
    }
    ...
    fn test_cache_on_pipeline() {
        ...
        assert!(
            result.is_ok(),
            "Should parse @cache on pipeline: {:?}",
            result.err()
        );
    }
}
...
mod configuration {
    ...
    fn test_config_with_nested_values() {
        ...
        assert!(
            result.is_ok(),
            "Should parse config with various value types: {:?}",
            result.err()
        );
    }
}
...
mod error_handling_syntax {
    ...
    fn test_try_multiple_catch() {
        ...
        assert!(
            result.is_ok(),
            "Should parse try with multiple catch clauses: {:?}",
            result.err()
        );
    }
    ...
    fn test_match_expression() {
        ...
        assert!(
            result.is_ok(),
            "Should parse match/case expression: {:?}",
            result.err()
        );
    }
    ...
    fn test_match_with_literals() {
        ...
        assert!(
            result.is_ok(),
            "Should parse match with integer literals: {:?}",
            result.err()
        );
    }
}
...
mod example_files {
    ...
    fn test_parse_collections_example() {
        ...
        assert!(
            result.is_ok(),
            "Should parse collections.zynml: {:?}",
            result.err()
        );
    }
...
mod grammar2_parsing {
    ...
    fn test_grammar2_parse_def_with_tuple_return_type() {
        ...
        assert!(
            result.is_ok(),
            "Should parse def with tuple return type: {:?}",
            result.err()
        );
        let program = result.unwrap();
        assert_eq!(program.declarations.len(), 1, "Should have 1 declaration");
    ...
    fn test_grammar2_parse_function_with_call() {
        ...
        assert!(
            result.is_ok(),
            "Should parse def with function call: {:?}",
            result.err()
        );
        let program = result.unwrap();
        assert_eq!(program.declarations.len(), 1, "Should have 1 declaration");
    ...
    fn test_grammar2_parse_multiple_functions() {
        ...
        assert!(
            result.is_ok(),
            "Should parse multiple functions: {:?}",
            result.err()
        );
        let program = result.unwrap();
    ...
    fn test_grammar2_parse_python_ternary() {
        ...
        assert!(
            result.is_ok(),
            "Should parse Python-style ternary: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_chained_null_coalesce() {
        ...
        assert!(
            result.is_ok(),
            "Should parse chained null-coalesce: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_ternary_with_expressions() {
        ...
        assert!(
            result.is_ok(),
            "Should parse ternary with variables: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_ternary_with_calls() {
        ...
        assert!(
            result.is_ok(),
            "Should parse ternary with function calls: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_call_with_arg_in_def_body() {
        ...
        assert!(
            result.is_ok(),
            "Should parse call with arg in def body: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_empty_call_in_def_body() {
        ...
        assert!(
            result.is_ok(),
            "Should parse empty call in def body: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_chained_field_access() {
        ...
        assert!(
            result.is_ok(),
            "Should parse chained field access: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_chained_method_with_args() {
        ...
        assert!(
            result.is_ok(),
            "Should parse chained methods with args: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_chained_index_access() {
        ...
        assert!(
            result.is_ok(),
            "Should parse chained index access: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_list_comprehension_simple() {
        ...
        assert!(
            result.is_ok(),
            "Should parse simple list comprehension: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_list_comprehension_with_expr() {
        ...
        assert!(
            result.is_ok(),
            "Should parse list comp with expression: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_list_comprehension_with_filter() {
        ...
        assert!(
            result.is_ok(),
            "Should parse list comp with filter: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_list_comprehension_complex() {
        ...
        assert!(
            result.is_ok(),
            "Should parse complex list comprehension: {:?}",
            result.err()
        );
    }
...
mod destructuring_patterns {
    ...
    fn test_grammar2_parse_tuple_destructure_simple() {
        ...
        assert!(
            result.is_ok(),
            "Should parse simple tuple destructure: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_tuple_destructure_three() {
        ...
        assert!(
            result.is_ok(),
            "Should parse three-element tuple destructure: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_tuple_destructure_with_wildcard() {
        ...
        assert!(
            result.is_ok(),
            "Should parse tuple destructure with wildcard: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_tuple_destructure_with_expr() {
        ...
        assert!(
            result.is_ok(),
            "Should parse tuple destructure with function call: {:?}",
            result.err()
        );
    }
}
...
mod annotations {
    ...
    fn test_grammar2_parse_simple_annotation() {
        ...
        assert!(
            result.is_ok(),
            "Should parse simple annotation: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_annotation_with_string_arg() {
        let grammar = get_grammar2();
        let result =
            grammar.parse(r#"@deprecated("Use new_function instead") def old_function() { 0 }"#);
        assert!(
            result.is_ok(),
            "Should parse annotation with string arg: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_annotation_with_named_args() {
        ...
        assert!(
            result.is_ok(),
            "Should parse annotation with named args: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_multiple_annotations() {
        ...
        assert!(
            result.is_ok(),
            "Should parse multiple annotations: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_annotation_with_identifier_args() {
        ...
        assert!(
            result.is_ok(),
            "Should parse annotation with identifier args: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_annotation_with_bool_arg() {
        ...
        assert!(
            result.is_ok(),
            "Should parse annotation with bool arg: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_annotation_with_int_arg() {
        ...
        assert!(
            result.is_ok(),
            "Should parse annotation with int arg: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_device_annotation() {
        ...
        assert!(
            result.is_ok(),
            "Should parse @device annotation: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_effect_annotation() {
        ...
        assert!(
            result.is_ok(),
            "Should parse @effect annotation: {:?}",
            result.err()
        );
    }
}
...
mod algebraic_effects {
    ...
    fn test_grammar2_parse_effect_declaration_simple() {
        ...
        assert!(
            result.is_ok(),
            "Should parse simple effect declaration: {:?}",
            result.err()
        );
        let program = result.unwrap();
        assert_eq!(program.declarations.len(), 1, "Should have 1 declaration");
    ...
    fn test_grammar2_parse_effect_declaration_generic() {
        ...
        assert!(
            result.is_ok(),
            "Should parse generic effect declaration: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_effect_declaration_probabilistic() {
        ...
        assert!(
            result.is_ok(),
            "Should parse probabilistic effect: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_effect_and_handler() {
        ...
        assert!(
            result.is_ok(),
            "Should parse effect and handler together: {:?}",
            result.err()
        );
        let program = result.unwrap();
        assert_eq!(program.declarations.len(), 2, "Should have 2 declarations");
    ...
    fn test_grammar2_parse_function_with_effect_annotation() {
        ...
        assert!(
            result.is_ok(),
            "Should parse function with @effect annotation: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_function_with_multiple_effects() {
        ...
        assert!(
            result.is_ok(),
            "Should parse function with multiple effects: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_with_annotation() {
        ...
        assert!(
            result.is_ok(),
            "Should parse @with handler annotation: {:?}",
            result.err()
        );
    }
    ...
    fn test_grammar2_parse_with_multiple_handlers() {
        ...
        assert!(
            result.is_ok(),
            "Should parse @with multiple handlers: {:?}",
            result.err()
        );
    }
}
...
mod runtime {
    ...
    fn test_runtime_creation_without_plugins() {
        ...
        assert!(
            result.is_ok(),
            "Runtime should create without plugins: {:?}",
            result.err()
        );
    }
    ...
    fn test_runtime_with_plugins() {
        ...
        assert!(
            result.is_ok(),
            "Should create runtime with plugins: {:?}",
            result.err()
        );
        ...
        assert!(
            zynml.has_plugin("zrtl_tensor"),
            "Should recognize tensor plugin"
        );
        assert!(
            zynml.has_plugin("zrtl_audio"),
            "Should recognize audio plugin"
        );
    }
}
...
mod execution {
    ...
    fn test_execute_hello_example() {
        ...
        let result =
            std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| zynml.run_file(&hello_path)));
...
mod error_handling {
    ...
    fn test_parse_error_missing_function_body() {
        ...
        assert!(
            result.is_err(),
            "Should fail on function with return type but no body"
        );
    }
}
